...
% Mark Whitty
% 160416
% Modified by Raghav Hariharan 05/04/22
...
% Creating the planes that the robotic arm cannot cross.
y_top = 0.6;
y_bottom = 0;

hold on;
plot_box([-1.5 1.5; 1 y_top], 'fillcolor','r')
plot_box([-1.5 1.5; y_bottom,-0.5], 'fillcolor','r')
two_link.plot(q1);
two_link.teach()
